...
*/
$output['ref']=$health2['referal'];
$check=0;
if($health2['referal'] != null)
{
    ...
    $returnVal=array("check"=>0,"data"=>"","referal"=>0);   
    if(array_key_exists("colNames", $output))
    {
        $returnVal["data"]= $output['colNames'];
        $returnVal["check"]=1;
        $returnVal["referal"]=$health2['referal'];
    }
return $returnVal;
}
?>