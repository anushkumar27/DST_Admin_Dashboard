...
<body onload="getData()">
			...
			<div class="navigation">
					<ul>
					  <li id="logMeOut"><a href="../">Back</a></li>
					</ul>
			</div><br><br>
			<div>
...
<script type="text/javascript">
	...
	var sch_id=<?php echo $_SESSION['schID'] ?>;
	console.log(sch_id);
	var stud_id=[];
	...
	var partial=[];
		...
		xhttp.onreadystatechange = function ()
		{
			if(xhttp.readyState==4 && xhttp.status==200)
			{
				...
				if(data==1)
				{
					document.getElementById("sch_table").innerHTML="<center><h3>No Student Health Data Available for "+sch_id+" : <?php echo $_SESSION['schNm'];?></h3></center><br><br>";
		...
		xhttp.open("POST","http://"+ip_address+"/report/ConsolidatedReport/school.php",false);
